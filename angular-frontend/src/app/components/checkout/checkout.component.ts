...
export class CheckoutComponent implements OnInit {
  ...
  onSubmit() {
    ...
    */
    ...
    const billingAddress = JSON.parse(JSON.stringify(purchase.billingAddress.country));
    purchase.billingAddress.country = billingAddress;
    ...
    this.checkoutService.placeOrder(purchase).subscribe({
        next: response => {
          alert(`Jouw bestelling is bevestigd.\n Bestelling trackingnummer: ${response.orderTrackingNumber}`);
        ...
        error: err => {
          alert(`Er is een fout: ${err.message}`);
        }
      }
    );
